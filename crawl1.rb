...
browser = @browser.get 'https://www.bikeseoul.com/login.do' # 로그인 페이지 가기

id_input = "//*[@id=\"memid\"]" # email 입력 부분
pw_input = "//*[@id=\"mempw\"]" # pw 입력 부분

inputID = @browser.find_element(xpath: id_input)
inputID.send_keys "taerin97" # id 입력
inputPW = @browser.find_element(xpath: pw_input)
inputPW.send_keys "fnqlghkdlxld!1" # pw 입력

@browser.find_element(xpath: "/html/body/div[1]/div/div/div/form/div[4]/a").click # 제출 버튼
...
@browser.navigate.to "https://www.bikeseoul.com/app/mybike/memberInfo/memberInfoEdit.do"
@x = puts @browser.find_element(xpath: "/html/body/div[1]/div[2]/div[2]/div[2]/form/div[1]/table/tbody/tr[1]/td/span").text + "님 환영합니다!"
